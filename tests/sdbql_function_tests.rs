...
fn test_function_upper() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN UPPER('hello')"),
        json!("HELLO")
    );
    assert_eq!(
        execute_query(&engine, "RETURN UPPER('Hello World')"),
        json!("HELLO WORLD")
    );
}
...
fn test_function_lower() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN LOWER('HELLO')"),
        json!("hello")
    );
    assert_eq!(
        execute_query(&engine, "RETURN LOWER('Hello World')"),
        json!("hello world")
    );
}
...
fn test_function_trim() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN TRIM('  hello  ')"),
        json!("hello")
    );
    assert_eq!(
        execute_query(&engine, "RETURN LTRIM('  hello  ')"),
        json!("hello  ")
    );
    assert_eq!(
        execute_query(&engine, "RETURN RTRIM('  hello  ')"),
        json!("  hello")
    );
}
...
fn test_function_concat() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN CONCAT('Hello', ' ', 'World')"),
        json!("Hello World")
    );
    assert_eq!(
        execute_query(&engine, "RETURN CONCAT('a', 'b', 'c')"),
        json!("abc")
    );
}
...
fn test_function_concat_separator() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN CONCAT_SEPARATOR(', ', ['a', 'b', 'c'])"),
        json!("a, b, c")
    );
    assert_eq!(
        execute_query(
            &engine,
            "RETURN CONCAT_SEPARATOR('-', ['2024', '01', '15'])"
        ),
        json!("2024-01-15")
    );
}
...
fn test_function_substring() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN SUBSTRING('Hello World', 0, 5)"),
        json!("Hello")
    );
    assert_eq!(
        execute_query(&engine, "RETURN SUBSTRING('Hello World', 6, 5)"),
        json!("World")
    );
}
...
fn test_function_contains() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN CONTAINS('Hello World', 'World')"),
        json!(true)
    );
    assert_eq!(
...
fn test_function_split() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN SPLIT('a,b,c', ',')"),
        json!(["a", "b", "c"])
    );
    assert_eq!(
        execute_query(&engine, "RETURN SPLIT('hello world', ' ')"),
        json!(["hello", "world"])
    );
}
...
fn test_function_substitute() {
    ...
    assert_eq!(
        execute_query(
            &engine,
            "RETURN SUBSTITUTE('Hello World', 'World', 'Universe')"
        ),
        json!("Hello Universe")
    );
}
...
fn test_function_regex_replace() {
    ...
    assert_eq!(
        execute_query(
            &engine,
            "RETURN REGEX_REPLACE('Hello 123 World', '[0-9]+', 'XXX')"
        ),
        json!("Hello XXX World")
    );
}
...
fn test_function_levenshtein() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN LEVENSHTEIN('kitten', 'sitting')"),
        json!(3)
    );
    assert_eq!(
        execute_query(&engine, "RETURN LEVENSHTEIN('hello', 'hello')"),
        json!(0)
    );
}
...
fn test_function_length() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN LENGTH([1, 2, 3, 4, 5])"),
        json!(5)
    );
...
fn test_function_first() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN FIRST(['a', 'b', 'c'])"),
        json!("a")
    );
}
...
fn test_function_last() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN LAST(['a', 'b', 'c'])"),
        json!("c")
    );
}
...
fn test_function_nth() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN NTH([10, 20, 30, 40], 0)"),
        json!(10)
    );
    assert_eq!(
        execute_query(&engine, "RETURN NTH([10, 20, 30, 40], 2)"),
        json!(30)
    );
}
...
fn test_function_slice() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN SLICE([1, 2, 3, 4, 5], 1, 3)"),
        json!([2, 3, 4])
    );
    assert_eq!(
        execute_query(&engine, "RETURN SLICE([1, 2, 3, 4, 5], 0, 2)"),
        json!([1, 2])
    );
}
...
fn test_function_reverse() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN REVERSE([1, 2, 3])"),
        json!([3, 2, 1])
    );
    assert_eq!(
        execute_query(&engine, "RETURN REVERSE(['a', 'b', 'c'])"),
        json!(["c", "b", "a"])
    );
}
...
fn test_function_sorted() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN SORTED([3, 1, 4, 1, 5])"),
        json!([1, 1, 3, 4, 5])
    );
}
...
fn test_function_flatten() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN FLATTEN([[1, 2], [3, 4], [5]])"),
        json!([1, 2, 3, 4, 5])
    );
}
...
fn test_function_push() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN PUSH([1, 2, 3], 4)"),
        json!([1, 2, 3, 4])
    );
}
...
fn test_function_append() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN APPEND([1, 2], [3, 4])"),
        json!([1, 2, 3, 4])
    );
}
...
fn test_function_union() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN UNION([1, 2], [3, 4])"),
        json!([1, 2, 3, 4])
    );
}
...
fn test_function_sum() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN SUM([1, 2, 3, 4, 5])"),
        json!(15.0)
    );
    assert_eq!(
        execute_query(&engine, "RETURN SUM([10, 20, 30])"),
        json!(60.0)
    );
}
...
fn test_function_avg() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN AVG([1, 2, 3, 4, 5])"),
        json!(3.0)
    );
    assert_eq!(
        execute_query(&engine, "RETURN AVG([10, 20, 30])"),
        json!(20.0)
    );
}
...
fn test_function_min() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN MIN([5, 2, 8, 1, 9])"),
        json!(1.0)
    );
}
...
fn test_function_max() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN MAX([5, 2, 8, 1, 9])"),
        json!(9.0)
    );
}
...
fn test_function_count_distinct() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN COUNT_DISTINCT([1, 2, 2, 3, 3, 3])"),
        json!(3)
    );
}
...
fn test_function_median() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN MEDIAN([1, 2, 3, 4, 5])"),
        json!(3.0)
    );
    assert_eq!(
        execute_query(&engine, "RETURN MEDIAN([1, 2, 3, 4])"),
        json!(2.5)
    );
}
...
fn test_function_is_array() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN IS_ARRAY([1, 2, 3])"),
        json!(true)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_ARRAY('not an array')"),
        json!(false)
    );
...
fn test_function_is_string() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN IS_STRING('hello')"),
        json!(true)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_STRING(123)"),
        json!(false)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_STRING([1, 2])"),
        json!(false)
    );
}
...
fn test_function_is_number() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN IS_NUMBER(3.14)"),
        json!(true)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_NUMBER('42')"),
        json!(false)
    );
}
...
fn test_function_is_object() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN IS_OBJECT({a: 1})"),
        json!(true)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_OBJECT([1, 2])"),
        json!(false)
    );
    assert_eq!(
        execute_query(&engine, "RETURN IS_OBJECT('string')"),
        json!(false)
    );
}
...
fn test_function_typename() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN TYPENAME([1, 2])"),
        json!("array")
    );
    assert_eq!(
        execute_query(&engine, "RETURN TYPENAME({a: 1})"),
        json!("object")
    );
    assert_eq!(
        execute_query(&engine, "RETURN TYPENAME(true)"),
        json!("bool")
    );
    assert_eq!(
        execute_query(&engine, "RETURN TYPENAME(null)"),
        json!("null")
    );
}
...
fn test_function_to_string() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN TO_STRING(true)"),
        json!("true")
    );
}
...
fn test_function_to_bool() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN TO_BOOL('true')"),
        json!(true)
    );
}
...
fn test_function_to_array() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN TO_ARRAY('hello')"),
        json!(["hello"])
    );
    assert_eq!(
        execute_query(&engine, "RETURN TO_ARRAY([1, 2])"),
        json!([1, 2])
    );
}
...
fn test_function_has() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN HAS({name: 'Alice', age: 30}, 'name')"),
        json!(true)
    );
    assert_eq!(
        execute_query(&engine, "RETURN HAS({name: 'Alice', age: 30}, 'email')"),
        json!(false)
    );
}
...
fn test_function_if() {
    ...
    assert_eq!(
        execute_query(&engine, "RETURN IF(true, 'yes', 'no')"),
        json!("yes")
    );
    assert_eq!(
        execute_query(&engine, "RETURN IF(false, 'yes', 'no')"),
        json!("no")
    );
    assert_eq!(
        execute_query(&engine, "RETURN IF(1 > 0, 'positive', 'negative')"),
        json!("positive")
    );
}
...
fn test_function_distance() {
    ...
    assert!(
        dist > 340000.0 && dist < 350000.0,
        "Distance should be ~344km in meters"
    );
}
