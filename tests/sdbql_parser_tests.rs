...
fn test_simple_for_return() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse simple FOR...RETURN: {:?}",
        result.err()
    );
}
...
fn test_for_with_filter() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FOR with FILTER: {:?}",
        result.err()
    );
}
...
fn test_for_with_sort_desc() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FOR with SORT DESC: {:?}",
        result.err()
    );
}
...
fn test_for_with_limit() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FOR with LIMIT: {:?}",
        result.err()
    );
}
...
fn test_for_with_limit_offset() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FOR with LIMIT offset: {:?}",
        result.err()
    );
}
...
fn test_let_with_expression() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse LET with expression: {:?}",
        result.err()
    );
}
...
fn test_multiple_let_bindings() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse multiple LET bindings: {:?}",
        result.err()
    );
}
...
fn test_filter_not_equals() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FILTER not equals: {:?}",
        result.err()
    );
}
...
fn test_filter_not_like() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FILTER NOT LIKE: {:?}",
        result.err()
    );
}
...
fn test_filter_not_regex() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse FILTER NOT regex: {:?}",
        result.err()
    );
}
...
fn test_insert_with_return() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse INSERT with RETURN NEW: {:?}",
        result.err()
    );
}
...
fn test_update() {
    let query =
        "FOR doc IN users FILTER doc._key == '123' UPDATE doc WITH { active: true } IN users";
    let result = parse(query);
...
fn test_update_with_return() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse UPDATE with RETURN NEW: {:?}",
        result.err()
    );
}
...
fn test_array_of_objects() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse array of objects: {:?}",
        result.err()
    );
}
...
fn test_function_length() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse LENGTH function: {:?}",
        result.err()
    );
}
...
fn test_function_upper() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse UPPER function: {:?}",
        result.err()
    );
}
...
fn test_function_lower() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse LOWER function: {:?}",
        result.err()
    );
}
...
fn test_ternary_expression() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse ternary expression: {:?}",
        result.err()
    );
}
...
fn test_graph_outbound() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse OUTBOUND traversal: {:?}",
        result.err()
    );
}
...
fn test_graph_inbound() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse INBOUND traversal: {:?}",
        result.err()
    );
}
...
fn test_graph_with_edge_variable() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse traversal with edge variable: {:?}",
        result.err()
    );
}
...
fn test_bind_variable_value() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse value bind variable: {:?}",
        result.err()
    );
}
...
fn test_bind_variable_in_limit() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse bind variables in LIMIT: {:?}",
        result.err()
    );
}
