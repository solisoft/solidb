...
async fn response_json(response: axum::response::Response) -> Value {
    ...
    serde_json::from_slice(&body).unwrap_or(json!({"raw": String::from_utf8_lossy(&body).to_string()}))
}
...
async fn test_create_collection_invalid_type() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .uri("/_api/database/testdb/collection")
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"name": "test", "type": "invalid_type"}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_insert_document_invalid_json() {
    ...
    app.clone().oneshot(Request::builder()
        ...
        .uri("/_api/database/testdb/collection")
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"name": "docs"}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_query_empty_query_string() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .uri("/_api/database/testdb/cursor")
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"query": ""}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_query_invalid_syntax() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .uri("/_api/database/testdb/cursor")
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"query": "FOR invalid syntax"}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_query_nonexistent_collection() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .uri("/_api/database/testdb/cursor")
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"query": "FOR doc IN nonexistent RETURN doc"}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_create_index_missing_fields() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .header("Content-Type", "application/json")
        .body(Body::from(json!({"type": "hash"}).to_string())).unwrap()
    ).await.unwrap();
...
async fn test_wrong_content_type() {
    ...
    let response = app.oneshot(Request::builder()
        ...
        .body(Body::from("name=test")).unwrap()
    ).await.unwrap();
