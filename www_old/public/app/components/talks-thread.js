...
var talksThread = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div expr42="expr42"><div expr43="expr43"><div class="flex items-center gap-2"><i class="fas fa-comments text-indigo-400"></i><span expr44="expr44">Thread</span><span expr45="expr45" class="text-gray-500 text-sm"></span></div><button expr46="expr46" type="button" title="Close Thread"><i class="fas fa-times"></i></button></div><div expr47="expr47"></div><div ref="threadMessages" class="flex-1 overflow-y-auto px-4 py-2 space-y-2 custom-scrollbar"><div expr58="expr58" class="text-center text-gray-500 py-8"></div><div expr59="expr59" class="flex items-start gap-3 group hover:bg-[#222529]/30 -mx-4 px-4 py-2 transition-colors relative"></div></div><talks-input expr79="expr79"></talks-input><div expr80="expr80" class="fixed bg-[#222529] border border-gray-700 rounded-lg shadow-2xl z-[9995] w-64 overflow-hidden animate-fade-in"></div></div>', [{
    ...
    selector: '[expr47]',
    template: template('<div class="flex items-start gap-3"><div expr48="expr48"> </div><div class="flex-1 min-w-0"><div class="flex items-baseline mb-1"><span expr49="expr49" class="font-bold text-white mr-2"> </span><span expr50="expr50" class="text-xs text-gray-500"> </span></div><div expr51="expr51" class="text-[#D1D2D3] leading-snug"> </div><div expr52="expr52" class="mt-2 flex flex-wrap gap-2"></div></div></div>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
      ...
      selector: '[expr52]',
      template: template('<div expr53="expr53" class="relative"></div>', [{
        type: bindingTypes.EACH,
        getKey: null,
        condition: null,
        template: template('<template expr54="expr54"></template><template expr56="expr56"></template>', [{
          type: bindingTypes.IF,
          evaluate: _scope => _scope.isImage(_scope.attachment),
          redundantAttribute: 'expr54',
          selector: '[expr54]',
          template: template('<img expr55="expr55" class="max-w-[120px] max-h-16 rounded border border-gray-700"/>', [{
          ...
          selector: '[expr56]',
          template: template('<div class="flex items-center p-2 rounded bg-[#222529] border border-gray-700 text-sm text-gray-400"><i class="fas fa-paperclip mr-2"></i><span expr57="expr57" class="truncate max-w-[100px]"> </span></div>', [{
    ...
    getKey: null,
    condition: null,
    template: template('<div expr60="expr60"> </div><div class="flex-1 min-w-0"><div class="flex items-baseline mb-0.5"><span expr61="expr61" class="font-bold text-white text-sm mr-2"> </span><span expr62="expr62" class="text-xs text-gray-500"> </span></div><div expr63="expr63" class="text-[#D1D2D3] text-sm leading-snug"></div><div expr65="expr65" class="mt-1"></div><div expr69="expr69" class="mt-2 flex flex-wrap gap-2"></div></div><div expr76="expr76" class="absolute top-2 right-2 flex items-center bg-[#1A1D21] border border-gray-700 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-10"></div>', [{
      ...
      selector: '[expr63]',
      template: template(' <span expr64="expr64" class="text-[10px] text-gray-500 ml-1"></span>', [{
        expressions: [{
          type: expressionTypes.TEXT,
          childNodeIndex: 0,
      ...
      selector: '[expr65]',
      template: template('<textarea expr66="expr66" class="w-full bg-[#222529] border border-blue-500 rounded p-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500 min-h-[60px]"> </textarea><div class="flex justify-end gap-2 mt-1"><button expr67="expr67" class="text-xs text-gray-400 hover:text-white px-2 py-1">Cancel</button><button expr68="expr68" class="text-xs bg-blue-600 hover:bg-blue-500 text-white px-2 py-1 rounded">Save\n                                Changes</button></div>', [{
      ...
      selector: '[expr69]',
      template: template('<div expr70="expr70" class="relative"></div>', [{
        type: bindingTypes.EACH,
        getKey: null,
        condition: null,
        template: template('<template expr71="expr71"></template><template expr73="expr73"></template>', [{
          type: bindingTypes.IF,
          evaluate: _scope => _scope.isImage(_scope.attachment),
          redundantAttribute: 'expr71',
          selector: '[expr71]',
          template: template('<img expr72="expr72" class="max-w-xs max-h-40 rounded border border-gray-700"/>', [{
          ...
          selector: '[expr73]',
          template: template('<a expr74="expr74" target="_blank" class="flex items-center p-2 rounded bg-[#222529] border border-gray-700 text-sm text-blue-400 hover:text-blue-300"><i class="fas fa-paperclip mr-2"></i><span expr75="expr75" class="truncate max-w-[150px]"> </span></a>', [{
      ...
      selector: '[expr76]',
      template: template('<button expr77="expr77" class="p-1.5 text-gray-400 hover:text-white\n                        transition-colors" title="Edit"><i class="fas fa-edit text-xs"></i></button><button expr78="expr78" class="p-1.5 text-gray-400\n                        hover:text-red-400 transition-colors" title="Delete"><i class="fas fa-trash-alt text-xs"></i></button>', [{
    ...
    template: template('<div class="p-2 border-b border-gray-700 bg-[#1A1D21] text-[10px] uppercase font-bold text-gray-500 tracking-wider">\n                People</div><div class="max-h-48 overflow-y-auto custom-scrollbar"><div expr81="expr81"></div></div>', [{
      ...
      getKey: null,
      condition: null,
      template: template('<div expr82="expr82" class="w-6 h-6 rounded-md bg-indigo-500 flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0"> </div><span expr83="expr83" class="text-sm truncate font-medium"> </span>', [{
        expressions: [{
          type: expressionTypes.EVENT,
          name: 'onclick',
