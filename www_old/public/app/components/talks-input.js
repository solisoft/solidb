var talksInput = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<footer class="p-0 flex-shrink-0"><div expr974="expr974"><div expr975="expr975"></div><div expr979="expr979"></div><div expr985="expr985"><textarea expr986="expr986" ref="messageInput" placeholder="Message"></textarea></div><div expr987="expr987"><div class="flex items-center space-x-1"><button expr988="expr988" class="text-gray-500 hover:text-white transition-colors p-2" title="Attach file"><i class="fas fa-paperclip"></i></button><button expr989="expr989"><i class="far fa-smile"></i></button></div><button expr990="expr990"><i expr991="expr991"></i> </button></div><input expr992="expr992" type="file" ref="fileInput" class="hidden" multiple/></div></footer>', [{
    ...
    selector: '[expr975]',
    template: template('<div class="flex items-center justify-between mb-1.5"><span expr976="expr976" class="font-bold text-indigo-400 text-xs tracking-wide uppercase flex items-center gap-1.5"><i class="fas fa-reply"></i> </span><button expr977="expr977" class="text-gray-500 hover:text-white p-1 rounded-full hover:bg-gray-700/50 transition-colors"><i class="fas fa-times"></i></button></div><div expr978="expr978" class="text-gray-300/80 line-clamp-2 italic text-sm"> </div><i class="fas fa-quote-right absolute bottom-2 right-3 text-white/5 text-xl pointer-events-none"></i>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
    ...
    selector: '[expr979]',
    template: template('<div expr980="expr980"></div>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
      ...
      getKey: null,
      condition: null,
      template: template('<div expr981="expr981"><i class="fas fa-file-code"></i></div><div class="flex flex-col max-w-[150px]"><span expr982="expr982"> </span><span expr983="expr983" class="text-[10px] text-gray-500"> </span></div><button expr984="expr984"><i class="fas fa-times"></i></button>', [{
        expressions: [{
          type: expressionTypes.ATTRIBUTE,
          isBoolean: false,
          name: 'class',
