...
var uploadBlobModal = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div expr818="expr818" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="animation: fadeIn 0.2s ease-out;"></div>', [{
    type: bindingTypes.IF,
    evaluate: _scope => _scope.state.visible,
    redundantAttribute: 'expr818',
    selector: '[expr818]',
    template: template('<div expr819="expr819" class="absolute inset-0 bg-black/60 backdrop-blur-sm transition-opacity"></div><div expr820="expr820" class="relative w-full max-w-xl bg-gray-900/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl transform transition-all" style="animation: slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1);"><div class="flex items-center justify-between p-6 border-b border-white/5"><div><h3 class="text-xl font-bold text-white tracking-tight">Upload Blob</h3><p expr821="expr821" class="text-sm text-gray-400 mt-1"> </p></div><button expr822="expr822" class="text-gray-400 hover:text-white transition-colors p-2 hover:bg-white/5 rounded-lg"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button></div><div expr823="expr823" class="px-6 pt-6"></div><form expr825="expr825" class="p-6"><div class="mb-6"><label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">File\n                        Selection</label><div expr826="expr826"><div class="px-6 py-10 flex flex-col items-center justify-center text-center"><div expr827="expr827"><svg expr828="expr828" class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg><svg expr829="expr829" class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg></div><div expr830="expr830" class="space-y-1"></div><div expr831="expr831" class="space-y-1 animate-fadeIn"></div></div></div><input expr834="expr834" type="file" ref="fileInput" class="hidden"/></div><div expr835="expr835" class="mb-6 space-y-2"></div><div class="flex justify-end space-x-3 pt-2"><button expr838="expr838" type="button" class="px-4 py-2 text-sm font-medium text-gray-400 hover:text-white transition-colors hover:bg-white/5 rounded-lg">\n                        Cancel\n                    </button><button expr839="expr839" type="submit" class="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg transition-all shadow-lg shadow-indigo-900/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center"><svg expr840="expr840" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24"></svg> </button></div></form></div>', [{
      ...
      selector: '[expr831]',
      template: template('<p expr832="expr832" class="text-sm font-medium text-white break-all px-4"> </p><p expr833="expr833" class="text-xs text-indigo-400 font-mono"> </p>', [{
      ...
      selector: '[expr835]',
      template: template('<div class="flex justify-between text-xs font-medium"><span class="text-indigo-400">Uploading...</span><span expr836="expr836" class="text-gray-400"> </span></div><div class="w-full bg-gray-800 rounded-full h-1.5 overflow-hidden"><div expr837="expr837" class="bg-indigo-500 h-1.5 rounded-full transition-all duration-300 ease-out relative"><div class="absolute inset-0 bg-white/20 animate-pulse"></div></div></div>', [{
