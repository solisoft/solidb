var talksHeader = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<header expr539="expr539"><div class="flex items-center min-w-0 flex-1"><button expr540="expr540" class="mr-3 p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><h2 expr541="expr541" class="text-xl font-bold text-white mr-2 truncate flex items-center"><i expr542="expr542" class="fas fa-lock text-sm mr-2 text-gray-400"></i><span expr543="expr543" class="mr-1"></span> </h2><button expr544="expr544" class="text-gray-400 hover:text-white transition-colors"><i expr545="expr545"></i></button></div><div class="flex items-center space-x-4"><div expr546="expr546" class="relative"></div><div expr561="expr561"><div expr562="expr562" class="flex items-center gap-2 bg-green-600/20 border border-green-500/50 px-3 py-1.5 rounded-full animate-pulse"></div><template expr566="expr566"></template></div><div class="relative"><button expr569="expr569" class="p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><div expr570="expr570"><input expr571="expr571" type="text" placeholder="Search messages..." ref="searchInput" class="bg-[#222529] border border-gray-700 text-sm rounded-md px-3 py-1.5 focus:outline-none\n                    focus:border-indigo-500 w-64 transition-all text-gray-200"/><i class="fas fa-search absolute right-3 top-2.5 text-gray-500"></i></div></div><button expr572="expr572"><i class="fas fa-info-circle"></i></button></div></header>', [{
    ...
    selector: '[expr546]',
    template: template('<button expr547="expr547" class="flex items-center gap-2 text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50\n                    px-3 py-1.5 rounded-md transition-colors"><i class="fas fa-users text-xs"></i><span expr548="expr548" class="text-sm"> </span></button><div expr549="expr549" class="absolute right-0 top-full mt-2 w-72 bg-[#1A1D21] border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden flex flex-col max-h-[80vh]"></div>', [{
      ...
      selector: '[expr549]',
      template: template('<div class="p-3 border-b border-gray-700 flex items-center justify-between bg-gray-800/30"><span class="text-sm font-semibold text-white">Channel Members</span><button expr550="expr550" class="text-gray-400 hover:text-white"><i class="fas fa-times"></i></button></div><div class="p-3 border-b border-gray-700 bg-gray-900/50"><div class="relative"><i class="fas fa-user-plus absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-xs"></i><input expr551="expr551" type="text" placeholder="Add someone..." class="w-full bg-[#1A1D21] border border-gray-700 rounded text-xs px-7 py-2 text-white focus:outline-none focus:border-indigo-500"/></div><div expr552="expr552" class="mt-2 max-h-40 overflow-y-auto custom-scrollbar\n                            bg-[#1A1D21] border border-gray-700 rounded shadow-inner"></div></div><div class="overflow-y-auto custom-scrollbar p-2 flex-1"><div expr556="expr556" class="flex items-center gap-2 p-2 hover:bg-white/5 rounded group"></div></div>', [{
        ...
        selector: '[expr552]',
        template: template('<div expr553="expr553" class="flex items-center gap-2 p-2 hover:bg-indigo-600/20 cursor-pointer\n                                transition-colors group"></div>', [{
          type: bindingTypes.EACH,
          getKey: null,
          condition: null,
          template: template('<div expr554="expr554" class="w-6 h-6 rounded bg-indigo-500 flex items-center justify-center text-[10px] font-bold text-white"> </div><div class="flex-1 min-w-0"><div expr555="expr555" class="text-gray-200 text-xs truncate group-hover:text-white"> </div></div><i class="fas fa-plus text-gray-600 group-hover:text-indigo-400 text-[10px]"></i>', [{
            expressions: [{
              type: expressionTypes.EVENT,
              name: 'onclick',
        ...
        getKey: null,
        condition: null,
        template: template('<div expr557="expr557" class="w-8 h-8 rounded bg-gradient-to-br from-indigo-500 to-purple-600 text-xs flex items-center justify-center text-white font-bold shrink-0"> </div><div class="flex-1 min-w-0"><div expr558="expr558" class="text-gray-200 text-sm truncate font-medium"> </div><div expr559="expr559" class="text-gray-500 text-[10px] truncate"> </div></div><button expr560="expr560" class="opacity-0 group-hover:opacity-100 p-1.5 text-gray-500 hover:text-red-400\n                                transition-all" title="Remove member"></button>', [{
    ...
    selector: '[expr562]',
    template: template('<div class="flex -space-x-2"><div expr563="expr563" class="w-6 h-6 rounded-full bg-green-600 border-2 border-gray-900 flex items-center justify-center text-white text-[10px] font-bold"></div><div expr564="expr564" class="w-6 h-6 rounded-full bg-gray-700 border-2 border-gray-900 flex items-center\n                            justify-center text-white text-[10px]"></div></div><span class="text-green-400 text-sm font-medium">Huddle</span><button expr565="expr565" class="bg-green-600 hover:bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium\n                        transition-colors flex items-center gap-1"><i class="fas fa-headphones text-xs"></i>\n                        Join\n                    </button>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template(' ', [{
    ...
    selector: '[expr566]',
    template: template('<button expr567="expr567" title="Start Audio Call"><i class="fas fa-phone"></i></button><button expr568="expr568" title="Start Video Call"><i class="fas fa-video"></i></button>', [{
