...
var envManager = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div class="bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-gray-700 p-6"><div class="mb-8 p-4 bg-gray-750/50 rounded-lg border border-gray-700"><h3 class="text-lg font-medium text-gray-200 mb-4">Add / Update Variable</h3><form expr158="expr158" class="flex gap-4 items-end"><div class="flex-1"><label class="block text-sm font-medium text-gray-400 mb-1">Key</label><input expr159="expr159" type="text" id="env-key" required placeholder="API_KEY" class="w-full bg-gray-900 border border-gray-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm"/></div><div class="flex-2 w-full"><label class="block text-sm font-medium text-gray-400 mb-1">Value</label><input expr160="expr160" type="text" id="env-value" required placeholder="secret_value_123" class="w-full bg-gray-900 border border-gray-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm"/></div><button expr161="expr161" type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"> </button></form></div><div expr162="expr162" class="flex justify-center items-center py-12"></div><div expr163="expr163" class="text-center py-6 bg-red-900/20 rounded-lg border border-red-500/30 mb-6"></div><div expr166="expr166" class="text-center py-12"></div><div expr167="expr167" class="overflow-x-auto"></div><div class="mt-6 p-4 bg-gray-900/50 rounded-md border border-gray-700/50"><h4 class="text-sm font-medium text-gray-300 mb-2">Usage in Lua Scripts</h4><p class="text-xs text-gray-400 font-mono bg-gray-800 p-2 rounded border border-gray-700">\n                local api_key = solidb.env.API_KEY\n            </p></div></div>', [{
    ...
    selector: '[expr163]',
    template: template('<p expr164="expr164" class="text-red-400"> </p><button expr165="expr165" class="mt-2 text-indigo-400 hover:text-indigo-300">Retry</button>', [{
    ...
    selector: '[expr167]',
    template: template('<table class="min-w-full divide-y divide-gray-700"><thead class="bg-gray-750"><tr><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider w-1/4">\n                            Key</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Value\n                        </th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-300 uppercase tracking-wider w-32">\n                            Actions</th></tr></thead><tbody class="bg-gray-800 divide-y divide-gray-700"><tr expr168="expr168" class="hover:bg-gray-750 transition-colors group"></tr></tbody></table>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template('<td expr169="expr169" class="px-6 py-4 whitespace-nowrap text-sm font-mono text-indigo-400 font-medium"> </td><td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-300"><span expr170="expr170"></span><span expr171="expr171" class="text-gray-500"></span></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex justify-end space-x-3"><button expr172="expr172" class="text-gray-500 hover:text-indigo-400 transition-colors focus:outline-none"><svg expr173="expr173" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg><svg expr174="expr174" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg></button><button expr175="expr175" title="Copy Value" class="text-gray-500 hover:text-green-400 transition-colors focus:outline-none"><svg expr176="expr176" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg><svg expr177="expr177" class="h-5 w-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg></button><button expr178="expr178" title="Delete Variable" class="text-gray-500 hover:text-red-400 transition-colors focus:outline-none"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></td>', [{
