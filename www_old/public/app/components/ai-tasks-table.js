...
var aiTasksTable = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div class="bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-gray-700"><div class="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-800/50 backdrop-blur-sm"><div class="flex space-x-4"><div class="relative"><select expr881="expr881" class="appearance-none bg-gray-900 border border-gray-600 text-gray-300 py-2 pl-4 pr-8 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"><option value>All Statuses</option><option value="pending">Pending</option><option value="running">Running</option><option value="completed">Completed</option><option value="failed">Failed</option></select><div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-400"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></div></div></div><div class="flex space-x-2"><span expr882="expr882" class="flex items-center text-xs text-green-400"></span><button expr883="expr883" class="text-gray-400 hover:text-white transition-colors p-2 rounded-full hover:bg-gray-700"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg></button></div></div><div expr884="expr884" class="flex justify-center items-center py-12"></div><div expr885="expr885" class="text-center py-12"></div><div expr887="expr887" class="text-center py-12"></div><table expr888="expr888" class="min-w-full divide-y divide-gray-700"></table></div>', [{
    ...
    selector: '[expr885]',
    template: template('<p expr886="expr886" class="text-red-400"> </p>', [{
    ...
    selector: '[expr888]',
    template: template('<thead class="bg-gray-700"><tr><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Task</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Priority\n                    </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Status\n                    </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Agent\n                    </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Updated\n                    </th></tr></thead><tbody class="bg-gray-800 divide-y divide-gray-700"><tr expr889="expr889" class="hover:bg-gray-750 transition-colors"></tr></tbody>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template('<td class="px-6 py-4"><div expr890="expr890" class="text-sm font-medium text-white"> </div><div expr891="expr891" class="text-xs text-gray-500 font-mono mt-1"> </div></td><td class="px-6 py-4 whitespace-nowrap"><span expr892="expr892"> </span></td><td class="px-6 py-4 whitespace-nowrap"><span expr893="expr893"> </span><div expr894="expr894" class="text-xs text-red-400 mt-1 max-w-xs"></div></td><td expr895="expr895" class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"> </td><td expr896="expr896" class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"> </td>', [{
