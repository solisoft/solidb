...
CustomRoute("POST", "/talks/add_channel_member", "talks#add_channel_member")
CustomRoute("POST", "/talks/remove_channel_member", "talks#remove_channel_member")
...
CustomRoute("POST", "/talks/update_message", "talks#update_message")
CustomRoute("POST", "/talks/delete_message", "talks#delete_message")
...
CustomRoute("GET", "/talks/get_thread_messages", "talks#get_thread_messages")
CustomRoute("POST", "/talks/send_thread_reply", "talks#send_thread_reply")
...
CustomRoute("GET", "/database/:db/repl", "dashboard#repl")
