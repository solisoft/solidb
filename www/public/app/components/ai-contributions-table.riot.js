    ...
    async loadContributions() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                this.update({ contributions: data.contributions, loading: false })
            } else {
  ...
  template: (
    ...
    [
      ...
      },
      {
        ...
        template: template(
          '<div class="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-500"></div><span class="ml-3 text-gray-400">Loading contributions...</span>',
          []
        )
      },
      {
        ...
        template: template(
          '<p expr326="expr326" class="text-red-400"> </p><button expr327="expr327" class="mt-4 text-indigo-400 hover:text-indigo-300">Retry</button>',
          [
            {
          ...
          [
            {
              ...
              template: template(
                '<td class="px-6 py-4 whitespace-nowrap"><span expr331="expr331"> </span></td><td class="px-6 py-4"><div expr332="expr332" class="text-sm text-gray-100 font-medium truncate max-w-md"> </div><div expr333="expr333" class="text-xs text-gray-500 mt-1"> </div></td><td class="px-6 py-4 whitespace-nowrap"><span expr334="expr334"> </span></td><td class="px-6 py-4 whitespace-nowrap"><div expr335="expr335" class="flex items-center"></div><span expr338="expr338" class="text-xs text-gray-500"></span></td><td expr339="expr339" class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"> </td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2"><button expr340="expr340" class="text-green-400\n                            hover:text-green-300 transition-colors" title="Approve"></button><button expr341="expr341" class="text-red-400 hover:text-red-300 transition-colors" title="Reject"></button></td>',
                [
                  {
                    ...
                    expressions: [
                      ...
                      },
                      {
                        ...
                        evaluate: _scope => [
                          ...
                          'item.contribution_type === \'feature\' ? \'bg-purple-900/30 text-purple-400\' :\\n                item.contribution_type === \'bugfix\' ? \'bg-red-900/30 text-red-400\' :\\n                item.contribution_type === \'enhancement\' ? \'bg-blue-900/30 text-blue-400\' : \'bg-gray-700 text-gray-300\''
                        ].join(
                          ''
                        )
                      }
                  ...
                  },
                  {
                    ...
                    template: template(
                      '<div class="h-2 w-16 bg-gray-700 rounded-full overflow-hidden"><div expr336="expr336"></div></div><span expr337="expr337" class="ml-2 text-xs text-gray-400"> </span>',
                      [
                        {
                          ...
                          expressions: [
                            {
                              ...
                              evaluate: _scope => [
                                'h-full ',
                                _scope.item.risk_score > 0.7 ? 'bg-red-500' : _scope.item.risk_score > 0.3 ? 'bg-yellow-500' : 'bg-green-500'
                              ].join(
                                ''
                              )
                            },
                    ...
                    expressions: [
                      {
                        ...
                        evaluate: _scope => [
                          new Date(_scope.item.updated_at).toLocaleDateString()
                        ].join(
                          ''
                        )
                      }
