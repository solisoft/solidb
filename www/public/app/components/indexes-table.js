...
var indexesTable = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div class="bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-gray-700"><div expr487="expr487" class="flex justify-center items-center py-12"></div><div expr488="expr488" class="text-center py-12"></div><div expr491="expr491" class="text-center py-12"></div><table expr493="expr493" class="min-w-full divide-y divide-gray-700"></table></div>', [{
    ...
    selector: '[expr488]',
    template: template('<p expr489="expr489" class="text-red-400"> </p><button expr490="expr490" class="mt-4 text-indigo-400 hover:text-indigo-300">Retry</button>', [{
    ...
    selector: '[expr491]',
    template: template('<svg class="mx-auto h-12 w-12 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg><h3 class="mt-2 text-sm font-medium text-gray-300">No indexes</h3><p class="mt-1 text-sm text-gray-500">Get started by creating a new index.</p><div class="mt-6"><button expr492="expr492" class="inline-flex items-center px-4 py-2 border\n          border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">\n          Create Index\n        </button></div>', [{
