var talksSidebar = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<aside expr581="expr581"><div class="p-4 border-b border-gray-800 flex items-center justify-between"><div class="flex items-center"><button expr582="expr582" class="mr-3 p-2 text-gray-400 hover:text-white lg:hidden transition-colors"></button><h1 class="text-xl font-bold text-white">SoliDB Talks</h1></div><div class="flex items-center gap-2"><div expr583="expr583"></div><button expr584="expr584" class="p-2 text-gray-400 hover:text-white transition-colors"></button></div></div><div expr585="expr585"><div expr586="expr586" class="mb-6"></div><div class="mb-6"><div class="px-4 flex items-center justify-between text-gray-400 uppercase text-xs font-bold mb-2"><span>Channels</span><div class="relative group"><button expr597="expr597" class="hover:text-white"><i class="fas fa-plus"></i></button><div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-black text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">\n                            Create Channel</div></div></div><nav><a expr598="expr598"></a></nav></div><div><div class="px-4 flex items-center justify-between text-gray-400 uppercase text-xs font-bold mb-2"><span>Direct Messages</span><button expr605="expr605" class="hover:text-white"><i class="fas fa-plus"></i></button></div><nav><a expr606="expr606"></a></nav></div></div><div class="p-4 bg-[#121016] border-t border-gray-800"><div class="flex items-center"><div expr610="expr610" class="w-9 h-9 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold mr-3 shadow-lg"> </div><div class="flex-1 min-w-0"><p expr611="expr611" class="text-sm font-bold text-white truncate"> </p><div class="relative"><button expr612="expr612" class="flex items-center text-xs text-gray-400 hover:text-white transition-colors focus:outline-none rounded px-1 -ml-1 group"><span expr613="expr613"></span><span expr614="expr614"> </span><i class="fas fa-chevron-up ml-1 text-[10px] opacity-0 group-hover:opacity-100 transition-opacity"></i></button><div expr615="expr615" class="absolute bottom-full left-0 mb-2 w-32 bg-[#222529] border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden animate-fade-in-up"></div><div expr619="expr619" class="fixed inset-0 z-40"></div></div></div><a href="/talks/logout" class="ml-2 p-2 text-gray-500 hover:text-white transition-colors" title="Logout"><i class="fas fa-sign-out-alt"></i></a></div></div></aside>', [{
    ...
    selector: '[expr586]',
    template: template('<div class="px-4 flex items-center justify-between text-gray-400 uppercase text-xs font-bold mb-2"><span>Favorites</span></div><nav><a expr587="expr587"></a></nav>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template('<span class="mr-2 w-4 text-center inline-block flex items-center justify-center"><template expr588="expr588"></template><template expr590="expr590"></template></span><span expr593="expr593" class="truncate"> </span><div expr594="expr594" class="ml-auto flex items-center gap-1 text-green-400" title="Huddle in progress"></div><div expr596="expr596" class="ml-auto w-2 h-2 bg-blue-400 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.6)] animate-pulse"></div>', [{
        expressions: [{
          type: expressionTypes.ATTRIBUTE,
          isBoolean: false,
          name: 'href',
        ...
        selector: '[expr588]',
        template: template('<div expr589="expr589"></div>', [{
        ...
        selector: '[expr590]',
        template: template('<i expr591="expr591" class="fas fa-lock text-xs"></i><span expr592="expr592"></span>', [{
          type: bindingTypes.IF,
        ...
        selector: '[expr594]',
        template: template('<i class="fas fa-headphones text-[10px] animate-pulse"></i><span expr595="expr595" class="text-[10px]"> </span>', [{
    ...
    condition: null,
    template: template('<span class="mr-2 w-4 text-center inline-block"><i expr599="expr599" class="fas fa-lock text-xs"></i><i expr600="expr600" class="fas fa-at text-xs text-orange-400"></i><span expr601="expr601"></span></span> <div expr602="expr602" class="ml-auto flex items-center gap-1 text-green-400" title="Huddle in progress"></div><div expr604="expr604" class="ml-auto w-2 h-2 bg-blue-400 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.6)] animate-pulse"></div>', [{
      expressions: [{
        type: expressionTypes.TEXT,
        childNodeIndex: 1,
      ...
      selector: '[expr602]',
      template: template('<i class="fas fa-headphones text-[10px] animate-pulse"></i><span expr603="expr603" class="text-[10px]"> </span>', [{
    ...
    template: template('<div expr607="expr607"></div><span expr608="expr608" class="flex-1 truncate"> </span><div expr609="expr609" class="ml-2 w-2 h-2 bg-blue-400 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.6)] animate-pulse"></div>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'href',
    ...
    selector: '[expr615]',
    template: template('<div class="p-1 space-y-0.5"><button expr616="expr616" class="w-full text-left px-3\n                                    py-1.5 text-xs text-gray-300 hover:text-white hover:bg-gray-700 rounded flex\n                                    items-center transition-colors"><span class="w-2 h-2 rounded-full bg-green-500 mr-2"></span> Active</button><button expr617="expr617" class="w-full text-left px-3\n                                    py-1.5 text-xs text-gray-300 hover:text-white hover:bg-gray-700 rounded flex\n                                    items-center transition-colors"><span class="w-2 h-2 rounded-full bg-red-500 mr-2"></span> Busy</button><button expr618="expr618" class="w-full text-left px-3\n                                    py-1.5 text-xs text-gray-300 hover:text-white hover:bg-gray-700 rounded flex\n                                    items-center transition-colors"><span class="w-2 h-2 rounded-full bg-gray-500 mr-2"></span> Off</button></div>', [{
