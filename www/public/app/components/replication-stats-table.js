...
var replicationStatsTable = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div class="space-y-6 mt-8"><div class="bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-gray-700"><div class="px-6 py-4 border-b border-gray-700 flex justify-between items-center"><h3 class="text-lg font-semibold text-gray-100">Detailed Replication Stats (From _cluster_informations)\n                </h3><button expr184="expr184" class="text-sm text-indigo-400 hover:text-indigo-300 flex items-center"><svg expr185="expr185" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>\n                    Refresh\n                </button></div><div expr186="expr186" class="p-6 text-center"></div><div expr187="expr187" class="p-6 text-center"></div><div expr189="expr189" class="p-6 text-center"></div><div expr190="expr190" class="overflow-x-auto"></div></div></div>', [{
    ...
    selector: '[expr187]',
    template: template('<p expr188="expr188" class="text-red-400"> </p>', [{
    ...
    template: template('<table class="min-w-full divide-y divide-gray-600"><thead class="bg-gray-700"><tr><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">\n                                Database/Collection</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">\n                                Shards</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">\n                                Replication Factor</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">\n                                Status</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">\n                                Details</th></tr></thead><tbody class="divide-y divide-gray-600"><tr expr191="expr191" class="hover:bg-gray-700 transition-colors"></tr></tbody></table>', [{
      ...
      template: template('<td class="px-6 py-4 whitespace-nowrap"><div expr192="expr192" class="text-sm font-medium text-gray-100"> </div></td><td expr193="expr193" class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"> </td><td expr194="expr194" class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"> </td><td class="px-6 py-4 whitespace-nowrap"><span expr195="expr195"> </span><div expr196="expr196" class="mt-1"></div></td><td class="px-6 py-4 text-sm text-gray-400"><div expr198="expr198" class="mb-1"></div></td>', [{
        ...
        selector: '[expr196]',
        template: template('<span expr197="expr197" class="text-xs text-amber-400 block"></span>', [{
          type: bindingTypes.EACH,
          getKey: null,
          condition: null,
          template: template(' ', [{
        ...
        getKey: null,
        condition: null,
        template: template('<span expr199="expr199" class="text-indigo-300 font-mono"> </span><span expr200="expr200" class="text-gray-300"> </span><span expr201="expr201" class="text-gray-400"></span>', [{
