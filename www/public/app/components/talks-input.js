var talksInput = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<footer class="p-0 flex-shrink-0"><div expr176="expr176"><div expr177="expr177"></div><div expr181="expr181"></div><div expr187="expr187"><textarea expr188="expr188" ref="messageInput" placeholder="Message"></textarea></div><div expr189="expr189"><div class="flex items-center space-x-1"><button expr190="expr190" class="text-gray-500 hover:text-white transition-colors p-2" title="Attach file"><i class="fas fa-paperclip"></i></button><button expr191="expr191"><i class="far fa-smile"></i></button></div><button expr192="expr192"><i expr193="expr193"></i> </button></div><input expr194="expr194" type="file" ref="fileInput" class="hidden" multiple/></div></footer>', [{
    ...
    selector: '[expr177]',
    template: template('<div class="flex items-center justify-between mb-1.5"><span expr178="expr178" class="font-bold text-indigo-400 text-xs tracking-wide uppercase flex items-center gap-1.5"><i class="fas fa-reply"></i> </span><button expr179="expr179" class="text-gray-500 hover:text-white p-1 rounded-full hover:bg-gray-700/50 transition-colors"><i class="fas fa-times"></i></button></div><div expr180="expr180" class="text-gray-300/80 line-clamp-2 italic text-sm"> </div><i class="fas fa-quote-right absolute bottom-2 right-3 text-white/5 text-xl pointer-events-none"></i>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
    ...
    selector: '[expr181]',
    template: template('<div expr182="expr182"></div>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
      ...
      getKey: null,
      condition: null,
      template: template('<div expr183="expr183"><i class="fas fa-file-code"></i></div><div class="flex flex-col max-w-[150px]"><span expr184="expr184"> </span><span expr185="expr185" class="text-[10px] text-gray-500"> </span></div><button expr186="expr186"><i class="fas fa-times"></i></button>', [{
        expressions: [{
          type: expressionTypes.ATTRIBUTE,
          isBoolean: false,
          name: 'class',
