var talksInput = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<footer class="p-0 flex-shrink-0"><div expr258="expr258"><div expr259="expr259"></div><div expr263="expr263"></div><div expr269="expr269"><textarea expr270="expr270" ref="messageInput" placeholder="Message"></textarea></div><div expr271="expr271"><div class="flex items-center space-x-1"><button expr272="expr272" class="text-gray-500 hover:text-white transition-colors p-2" title="Attach file"><i class="fas fa-paperclip"></i></button><button expr273="expr273"><i class="far fa-smile"></i></button></div><button expr274="expr274"><i expr275="expr275"></i> </button></div><input expr276="expr276" type="file" ref="fileInput" class="hidden" multiple/></div></footer>', [{
    ...
    selector: '[expr259]',
    template: template('<div class="flex items-center justify-between mb-1.5"><span expr260="expr260" class="font-bold text-indigo-400 text-xs tracking-wide uppercase flex items-center gap-1.5"><i class="fas fa-reply"></i> </span><button expr261="expr261" class="text-gray-500 hover:text-white p-1 rounded-full hover:bg-gray-700/50 transition-colors"><i class="fas fa-times"></i></button></div><div expr262="expr262" class="text-gray-300/80 line-clamp-2 italic text-sm"> </div><i class="fas fa-quote-right absolute bottom-2 right-3 text-white/5 text-xl pointer-events-none"></i>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
    ...
    selector: '[expr263]',
    template: template('<div expr264="expr264"></div>', [{
      expressions: [{
        type: expressionTypes.ATTRIBUTE,
        isBoolean: false,
        name: 'class',
      ...
      getKey: null,
      condition: null,
      template: template('<div expr265="expr265"><i class="fas fa-file-code"></i></div><div class="flex flex-col max-w-[150px]"><span expr266="expr266"> </span><span expr267="expr267" class="text-[10px] text-gray-500"> </span></div><button expr268="expr268"><i class="fas fa-times"></i></button>', [{
        expressions: [{
          type: expressionTypes.ATTRIBUTE,
          isBoolean: false,
          name: 'class',
