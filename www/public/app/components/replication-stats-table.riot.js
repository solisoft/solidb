                    ...
                    expressions: [
                      {
                        ...
                        evaluate: _scope => [
                          _scope.stat.replication_factor
                        ].join(
                          ''
                        )
                      }
                    ...
                    expressions: [
                      ...
                      },
                      {
                        ...
                        evaluate: _scope => [
                          ...
                          _scope.stat.status === 'Ready' ? 'bg-green-900/30 text-green-400' : 'bg-amber-900/30 text-amber-400'
                        ].join(
                          ''
                        )
                      }
