...
export default {
  ...
  template: (
    ...
    '<div class="space-y-6"><div expr0="expr0" class="space-y-6"></div><div expr14="expr14" class="space-y-6"></div></div>',
    [
      {
        ...
        template: template(
          ...
          [
            ...
            },
            {
              ...
              template: template(
                '<input expr20="expr20" type="checkbox" class="h-4 w-4 bg-gray-700 border-gray-600 rounded text-indigo-600 focus:ring-indigo-500"/><span expr21="expr21"> </span>',
                [
                  {
