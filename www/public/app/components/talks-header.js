var talksHeader = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<header expr293="expr293"><div class="flex items-center min-w-0 flex-1"><button expr294="expr294" class="mr-3 p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><h2 expr295="expr295" class="text-xl font-bold text-white mr-2 truncate flex items-center"><i expr296="expr296" class="fas fa-lock text-sm mr-2 text-gray-400"></i><span expr297="expr297" class="mr-1"></span> </h2><button expr298="expr298" class="text-gray-400 hover:text-white transition-colors"><i expr299="expr299"></i></button></div><div class="flex items-center space-x-4"><div expr300="expr300" class="relative"></div><div expr315="expr315"><div expr316="expr316" class="flex items-center gap-2 bg-green-600/20 border border-green-500/50 px-3 py-1.5 rounded-full animate-pulse"></div><template expr320="expr320"></template></div><div class="relative"><button expr323="expr323" class="p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><div expr324="expr324"><input expr325="expr325" type="text" placeholder="Search messages..." ref="searchInput" class="bg-[#222529] border border-gray-700 text-sm rounded-md px-3 py-1.5 focus:outline-none\n                    focus:border-indigo-500 w-64 transition-all text-gray-200"/><i class="fas fa-search absolute right-3 top-2.5 text-gray-500"></i></div></div><button expr326="expr326"><i class="fas fa-info-circle"></i></button></div></header>', [{
    ...
    selector: '[expr300]',
    template: template('<button expr301="expr301" class="flex items-center gap-2 text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50\n                    px-3 py-1.5 rounded-md transition-colors"><i class="fas fa-users text-xs"></i><span expr302="expr302" class="text-sm"> </span></button><div expr303="expr303" class="absolute right-0 top-full mt-2 w-72 bg-[#1A1D21] border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden flex flex-col max-h-[80vh]"></div>', [{
      ...
      selector: '[expr303]',
      template: template('<div class="p-3 border-b border-gray-700 flex items-center justify-between bg-gray-800/30"><span class="text-sm font-semibold text-white">Channel Members</span><button expr304="expr304" class="text-gray-400 hover:text-white"><i class="fas fa-times"></i></button></div><div class="p-3 border-b border-gray-700 bg-gray-900/50"><div class="relative"><i class="fas fa-user-plus absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-xs"></i><input expr305="expr305" type="text" placeholder="Add someone..." class="w-full bg-[#1A1D21] border border-gray-700 rounded text-xs px-7 py-2 text-white focus:outline-none focus:border-indigo-500"/></div><div expr306="expr306" class="mt-2 max-h-40 overflow-y-auto custom-scrollbar\n                            bg-[#1A1D21] border border-gray-700 rounded shadow-inner"></div></div><div class="overflow-y-auto custom-scrollbar p-2 flex-1"><div expr310="expr310" class="flex items-center gap-2 p-2 hover:bg-white/5 rounded group"></div></div>', [{
        ...
        selector: '[expr306]',
        template: template('<div expr307="expr307" class="flex items-center gap-2 p-2 hover:bg-indigo-600/20 cursor-pointer\n                                transition-colors group"></div>', [{
          type: bindingTypes.EACH,
          getKey: null,
          condition: null,
          template: template('<div expr308="expr308" class="w-6 h-6 rounded bg-indigo-500 flex items-center justify-center text-[10px] font-bold text-white"> </div><div class="flex-1 min-w-0"><div expr309="expr309" class="text-gray-200 text-xs truncate group-hover:text-white"> </div></div><i class="fas fa-plus text-gray-600 group-hover:text-indigo-400 text-[10px]"></i>', [{
            expressions: [{
              type: expressionTypes.EVENT,
              name: 'onclick',
        ...
        getKey: null,
        condition: null,
        template: template('<div expr311="expr311" class="w-8 h-8 rounded bg-gradient-to-br from-indigo-500 to-purple-600 text-xs flex items-center justify-center text-white font-bold shrink-0"> </div><div class="flex-1 min-w-0"><div expr312="expr312" class="text-gray-200 text-sm truncate font-medium"> </div><div expr313="expr313" class="text-gray-500 text-[10px] truncate"> </div></div><button expr314="expr314" class="opacity-0 group-hover:opacity-100 p-1.5 text-gray-500 hover:text-red-400\n                                transition-all" title="Remove member"></button>', [{
    ...
    selector: '[expr316]',
    template: template('<div class="flex -space-x-2"><div expr317="expr317" class="w-6 h-6 rounded-full bg-green-600 border-2 border-gray-900 flex items-center justify-center text-white text-[10px] font-bold"></div><div expr318="expr318" class="w-6 h-6 rounded-full bg-gray-700 border-2 border-gray-900 flex items-center\n                            justify-center text-white text-[10px]"></div></div><span class="text-green-400 text-sm font-medium">Huddle</span><button expr319="expr319" class="bg-green-600 hover:bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium\n                        transition-colors flex items-center gap-1"><i class="fas fa-headphones text-xs"></i>\n                        Join\n                    </button>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template(' ', [{
    ...
    selector: '[expr320]',
    template: template('<button expr321="expr321" title="Start Audio Call"><i class="fas fa-phone"></i></button><button expr322="expr322" title="Start Video Call"><i class="fas fa-video"></i></button>', [{
