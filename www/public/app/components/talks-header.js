var talksHeader = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<header expr100="expr100"><div class="flex items-center min-w-0 flex-1"><button expr101="expr101" class="mr-3 p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><h2 expr102="expr102" class="text-xl font-bold text-white mr-2 truncate flex items-center"><i expr103="expr103" class="fas fa-lock text-sm mr-2 text-gray-400"></i><span expr104="expr104" class="mr-1"></span> </h2><button expr105="expr105" class="text-gray-400 hover:text-white transition-colors"><i expr106="expr106"></i></button></div><div class="flex items-center space-x-4"><div expr107="expr107" class="relative"></div><div expr122="expr122"><div expr123="expr123" class="flex items-center gap-2 bg-green-600/20 border border-green-500/50 px-3 py-1.5 rounded-full animate-pulse"></div><template expr127="expr127"></template></div><div class="relative"><button expr130="expr130" class="p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><div expr131="expr131"><input expr132="expr132" type="text" placeholder="Search messages..." ref="searchInput" class="bg-[#222529] border border-gray-700 text-sm rounded-md px-3 py-1.5 focus:outline-none\n                    focus:border-indigo-500 w-64 transition-all text-gray-200"/><i class="fas fa-search absolute right-3 top-2.5 text-gray-500"></i></div></div><button expr133="expr133"><i class="fas fa-info-circle"></i></button></div></header>', [{
    ...
    selector: '[expr107]',
    template: template('<button expr108="expr108" class="flex items-center gap-2 text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50\n                    px-3 py-1.5 rounded-md transition-colors"><i class="fas fa-users text-xs"></i><span expr109="expr109" class="text-sm"> </span></button><div expr110="expr110" class="absolute right-0 top-full mt-2 w-72 bg-[#1A1D21] border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden flex flex-col max-h-[80vh]"></div>', [{
      ...
      selector: '[expr110]',
      template: template('<div class="p-3 border-b border-gray-700 flex items-center justify-between bg-gray-800/30"><span class="text-sm font-semibold text-white">Channel Members</span><button expr111="expr111" class="text-gray-400 hover:text-white"><i class="fas fa-times"></i></button></div><div class="p-3 border-b border-gray-700 bg-gray-900/50"><div class="relative"><i class="fas fa-user-plus absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-xs"></i><input expr112="expr112" type="text" placeholder="Add someone..." class="w-full bg-[#1A1D21] border border-gray-700 rounded text-xs px-7 py-2 text-white focus:outline-none focus:border-indigo-500"/></div><div expr113="expr113" class="mt-2 max-h-40 overflow-y-auto custom-scrollbar\n                            bg-[#1A1D21] border border-gray-700 rounded shadow-inner"></div></div><div class="overflow-y-auto custom-scrollbar p-2 flex-1"><div expr117="expr117" class="flex items-center gap-2 p-2 hover:bg-white/5 rounded group"></div></div>', [{
        ...
        selector: '[expr113]',
        template: template('<div expr114="expr114" class="flex items-center gap-2 p-2 hover:bg-indigo-600/20 cursor-pointer\n                                transition-colors group"></div>', [{
          type: bindingTypes.EACH,
          getKey: null,
          condition: null,
          template: template('<div expr115="expr115" class="w-6 h-6 rounded bg-indigo-500 flex items-center justify-center text-[10px] font-bold text-white"> </div><div class="flex-1 min-w-0"><div expr116="expr116" class="text-gray-200 text-xs truncate group-hover:text-white"> </div></div><i class="fas fa-plus text-gray-600 group-hover:text-indigo-400 text-[10px]"></i>', [{
            expressions: [{
              type: expressionTypes.EVENT,
              name: 'onclick',
        ...
        getKey: null,
        condition: null,
        template: template('<div expr118="expr118" class="w-8 h-8 rounded bg-gradient-to-br from-indigo-500 to-purple-600 text-xs flex items-center justify-center text-white font-bold shrink-0"> </div><div class="flex-1 min-w-0"><div expr119="expr119" class="text-gray-200 text-sm truncate font-medium"> </div><div expr120="expr120" class="text-gray-500 text-[10px] truncate"> </div></div><button expr121="expr121" class="opacity-0 group-hover:opacity-100 p-1.5 text-gray-500 hover:text-red-400\n                                transition-all" title="Remove member"></button>', [{
    ...
    selector: '[expr123]',
    template: template('<div class="flex -space-x-2"><div expr124="expr124" class="w-6 h-6 rounded-full bg-green-600 border-2 border-gray-900 flex items-center justify-center text-white text-[10px] font-bold"></div><div expr125="expr125" class="w-6 h-6 rounded-full bg-gray-700 border-2 border-gray-900 flex items-center\n                            justify-center text-white text-[10px]"></div></div><span class="text-green-400 text-sm font-medium">Huddle</span><button expr126="expr126" class="bg-green-600 hover:bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium\n                        transition-colors flex items-center gap-1"><i class="fas fa-headphones text-xs"></i>\n                        Join\n                    </button>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template(' ', [{
    ...
    selector: '[expr127]',
    template: template('<button expr128="expr128" title="Start Audio Call"><i class="fas fa-phone"></i></button><button expr129="expr129" title="Start Video Call"><i class="fas fa-video"></i></button>', [{
