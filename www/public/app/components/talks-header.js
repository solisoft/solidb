var talksHeader = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<header expr161="expr161"><div class="flex items-center min-w-0 flex-1"><button expr162="expr162" class="mr-3 p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><h2 expr163="expr163" class="text-xl font-bold text-white mr-2 truncate flex items-center"><i expr164="expr164" class="fas fa-lock text-sm mr-2 text-gray-400"></i><span expr165="expr165" class="mr-1"></span> </h2><button expr166="expr166" class="text-gray-400 hover:text-white transition-colors"><i expr167="expr167"></i></button></div><div class="flex items-center space-x-4"><div expr168="expr168" class="relative"></div><div expr183="expr183"><div expr184="expr184" class="flex items-center gap-2 bg-green-600/20 border border-green-500/50 px-3 py-1.5 rounded-full animate-pulse"></div><template expr188="expr188"></template></div><div class="relative"><button expr191="expr191" class="p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-700/50"></button><div expr192="expr192"><input expr193="expr193" type="text" placeholder="Search messages..." ref="searchInput" class="bg-[#222529] border border-gray-700 text-sm rounded-md px-3 py-1.5 focus:outline-none\n                    focus:border-indigo-500 w-64 transition-all text-gray-200"/><i class="fas fa-search absolute right-3 top-2.5 text-gray-500"></i></div></div><button expr194="expr194"><i class="fas fa-info-circle"></i></button></div></header>', [{
    ...
    selector: '[expr168]',
    template: template('<button expr169="expr169" class="flex items-center gap-2 text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50\n                    px-3 py-1.5 rounded-md transition-colors"><i class="fas fa-users text-xs"></i><span expr170="expr170" class="text-sm"> </span></button><div expr171="expr171" class="absolute right-0 top-full mt-2 w-72 bg-[#1A1D21] border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden flex flex-col max-h-[80vh]"></div>', [{
      ...
      selector: '[expr171]',
      template: template('<div class="p-3 border-b border-gray-700 flex items-center justify-between bg-gray-800/30"><span class="text-sm font-semibold text-white">Channel Members</span><button expr172="expr172" class="text-gray-400 hover:text-white"><i class="fas fa-times"></i></button></div><div class="p-3 border-b border-gray-700 bg-gray-900/50"><div class="relative"><i class="fas fa-user-plus absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-xs"></i><input expr173="expr173" type="text" placeholder="Add someone..." class="w-full bg-[#1A1D21] border border-gray-700 rounded text-xs px-7 py-2 text-white focus:outline-none focus:border-indigo-500"/></div><div expr174="expr174" class="mt-2 max-h-40 overflow-y-auto custom-scrollbar\n                            bg-[#1A1D21] border border-gray-700 rounded shadow-inner"></div></div><div class="overflow-y-auto custom-scrollbar p-2 flex-1"><div expr178="expr178" class="flex items-center gap-2 p-2 hover:bg-white/5 rounded group"></div></div>', [{
        ...
        selector: '[expr174]',
        template: template('<div expr175="expr175" class="flex items-center gap-2 p-2 hover:bg-indigo-600/20 cursor-pointer\n                                transition-colors group"></div>', [{
          type: bindingTypes.EACH,
          getKey: null,
          condition: null,
          template: template('<div expr176="expr176" class="w-6 h-6 rounded bg-indigo-500 flex items-center justify-center text-[10px] font-bold text-white"> </div><div class="flex-1 min-w-0"><div expr177="expr177" class="text-gray-200 text-xs truncate group-hover:text-white"> </div></div><i class="fas fa-plus text-gray-600 group-hover:text-indigo-400 text-[10px]"></i>', [{
            expressions: [{
              type: expressionTypes.EVENT,
              name: 'onclick',
        ...
        getKey: null,
        condition: null,
        template: template('<div expr179="expr179" class="w-8 h-8 rounded bg-gradient-to-br from-indigo-500 to-purple-600 text-xs flex items-center justify-center text-white font-bold shrink-0"> </div><div class="flex-1 min-w-0"><div expr180="expr180" class="text-gray-200 text-sm truncate font-medium"> </div><div expr181="expr181" class="text-gray-500 text-[10px] truncate"> </div></div><button expr182="expr182" class="opacity-0 group-hover:opacity-100 p-1.5 text-gray-500 hover:text-red-400\n                                transition-all" title="Remove member"></button>', [{
    ...
    selector: '[expr184]',
    template: template('<div class="flex -space-x-2"><div expr185="expr185" class="w-6 h-6 rounded-full bg-green-600 border-2 border-gray-900 flex items-center justify-center text-white text-[10px] font-bold"></div><div expr186="expr186" class="w-6 h-6 rounded-full bg-gray-700 border-2 border-gray-900 flex items-center\n                            justify-center text-white text-[10px]"></div></div><span class="text-green-400 text-sm font-medium">Huddle</span><button expr187="expr187" class="bg-green-600 hover:bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium\n                        transition-colors flex items-center gap-1"><i class="fas fa-headphones text-xs"></i>\n                        Join\n                    </button>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template(' ', [{
    ...
    selector: '[expr188]',
    template: template('<button expr189="expr189" title="Start Audio Call"><i class="fas fa-phone"></i></button><button expr190="expr190" title="Start Video Call"><i class="fas fa-video"></i></button>', [{
