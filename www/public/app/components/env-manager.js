...
var envManager = {
  ...
  template: (template, expressionTypes, bindingTypes, getComponent) => template('<div class="bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-gray-700 p-6"><div class="mb-8 p-4 bg-gray-750/50 rounded-lg border border-gray-700"><h3 class="text-lg font-medium text-gray-200 mb-4">Add / Update Variable</h3><form expr654="expr654" class="flex gap-4 items-end"><div class="flex-1"><label class="block text-sm font-medium text-gray-400 mb-1">Key</label><input expr655="expr655" type="text" id="env-key" required placeholder="API_KEY" class="w-full bg-gray-900 border border-gray-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm"/></div><div class="flex-2 w-full"><label class="block text-sm font-medium text-gray-400 mb-1">Value</label><input expr656="expr656" type="text" id="env-value" required placeholder="secret_value_123" class="w-full bg-gray-900 border border-gray-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm"/></div><button expr657="expr657" type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"> </button></form></div><div expr658="expr658" class="flex justify-center items-center py-12"></div><div expr659="expr659" class="text-center py-6 bg-red-900/20 rounded-lg border border-red-500/30 mb-6"></div><div expr662="expr662" class="text-center py-12"></div><div expr663="expr663" class="overflow-x-auto"></div><div class="mt-6 p-4 bg-gray-900/50 rounded-md border border-gray-700/50"><h4 class="text-sm font-medium text-gray-300 mb-2">Usage in Lua Scripts</h4><p class="text-xs text-gray-400 font-mono bg-gray-800 p-2 rounded border border-gray-700">\n                local api_key = solidb.env.API_KEY\n            </p></div></div>', [{
    ...
    selector: '[expr659]',
    template: template('<p expr660="expr660" class="text-red-400"> </p><button expr661="expr661" class="mt-2 text-indigo-400 hover:text-indigo-300">Retry</button>', [{
    ...
    selector: '[expr663]',
    template: template('<table class="min-w-full divide-y divide-gray-700"><thead class="bg-gray-750"><tr><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider w-1/4">\n                            Key</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Value\n                        </th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-300 uppercase tracking-wider w-32">\n                            Actions</th></tr></thead><tbody class="bg-gray-800 divide-y divide-gray-700"><tr expr664="expr664" class="hover:bg-gray-750 transition-colors group"></tr></tbody></table>', [{
      type: bindingTypes.EACH,
      getKey: null,
      condition: null,
      template: template('<td expr665="expr665" class="px-6 py-4 whitespace-nowrap text-sm font-mono text-indigo-400 font-medium"> </td><td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-300"><span expr666="expr666"></span><span expr667="expr667" class="text-gray-500"></span></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex justify-end space-x-3"><button expr668="expr668" class="text-gray-500 hover:text-indigo-400 transition-colors focus:outline-none"><svg expr669="expr669" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg><svg expr670="expr670" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg></button><button expr671="expr671" title="Copy Value" class="text-gray-500 hover:text-green-400 transition-colors focus:outline-none"><svg expr672="expr672" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg><svg expr673="expr673" class="h-5 w-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg></button><button expr674="expr674" title="Delete Variable" class="text-gray-500 hover:text-red-400 transition-colors focus:outline-none"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></td>', [{
