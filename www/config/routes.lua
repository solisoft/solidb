...
router.scope("/database/:db", { middleware = { "dashboard_auth" } }, function()
  ...
  router.post("/documents/:collection/blob_upload", "dashboard/collections#blob_upload")
  router.get("/documents/:collection/blob_download/:key", "dashboard/collections#blob_download")
  ...
  router.post("/queues/jobs/:job_id/run-now", "dashboard/queue#run_now")
