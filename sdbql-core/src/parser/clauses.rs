...
impl Parser {
    ...
    /// e.g., LET a = 1, b = 2, c = 3
    pub(crate) fn parse_let_clause(&mut self) -> SdbqlResult<Vec<LetClause>> {
        ...
        loop {
            let variable = if let Token::Identifier(name) = self.current_token() {
                ...
                return Err(SdbqlError::ParseError(
    ...
    pub(crate) fn parse_create_stream_clause(&mut self) -> SdbqlResult<CreateStreamClause> {
        ...
        let name = if let Token::Identifier(n) = self.current_token() {
            ...
            return Err(SdbqlError::ParseError("Expected stream name".to_string()));
        };
    ...
    pub(crate) fn parse_create_materialized_view_clause(
        &mut self,
    ) -> SdbqlResult<CreateMaterializedViewClause> {
        self.expect(Token::Create)?;
        ...
        let name = if let Token::Identifier(n) = self.current_token() {
            ...
            return Err(SdbqlError::ParseError("Expected view name".to_string()));
        };
    ...
    pub(crate) fn parse_refresh_materialized_view_clause(
        &mut self,
    ) -> SdbqlResult<RefreshMaterializedViewClause> {
    ...
    pub(crate) fn parse_window_clause(&mut self) -> SdbqlResult<WindowClause> {
    ...
    pub(crate) fn parse_filter_clause(&mut self) -> SdbqlResult<FilterClause> {
    ...
    pub(crate) fn parse_join_clause(&mut self) -> SdbqlResult<JoinClause> {
    ...
    pub(crate) fn parse_insert_clause(&mut self) -> SdbqlResult<InsertClause> {
    ...
    pub(crate) fn parse_update_clause(&mut self) -> SdbqlResult<UpdateClause> {
    ...
    pub(crate) fn parse_remove_clause(&mut self) -> SdbqlResult<RemoveClause> {
    ...
    pub(crate) fn parse_upsert_clause(&mut self) -> SdbqlResult<UpsertClause> {
    ...
    /// Parse COLLECT clause: COLLECT var = expr [, var = expr]* [INTO var] [WITH COUNT INTO var] [AGGREGATE ...]
    pub(crate) fn parse_collect_clause(&mut self) -> SdbqlResult<CollectClause> {
        ...
        if matches!(self.current_token(), Token::With) {
            ...
            // Allow identifiers or keyword names as variable names
    ...
    ) -> SdbqlResult<GraphTraversalClause> {
    ...
    pub(crate) fn parse_shortest_path_clause(
        ...
        vertex_var: String,
        edge_var: Option<String>,
    ) -> SdbqlResult<ShortestPathClause> {
    ...
    pub(crate) fn parse_sort_clause(&mut self) -> SdbqlResult<SortClause> {
    ...
    pub(crate) fn parse_limit_clause(&mut self) -> SdbqlResult<LimitClause> {
    ...
    pub(crate) fn parse_return_clause(&mut self) -> SdbqlResult<ReturnClause> {
