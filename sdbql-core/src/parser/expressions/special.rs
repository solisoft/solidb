...
use crate::ast::{Expression, TemplateStringPart, WindowSpec};
...
impl Parser {
    ...
    pub(crate) fn parse_lambda_expression(&mut self) -> SdbqlResult<Expression> {
    ...
    fn parse_lambda_params(&mut self) -> SdbqlResult<Vec<String>> {
    ...
    pub(super) fn parse_case_expression(&mut self) -> SdbqlResult<Expression> {
    ...
    fn parse_window_spec(&mut self) -> SdbqlResult<WindowSpec> {
    ...
    fn parse_partition_by(&mut self) -> SdbqlResult<Vec<Expression>> {
    ...
    fn parse_order_by(&mut self) -> SdbqlResult<Vec<(Expression, bool)>> {
    ...
    pub(super) fn parse_quantifier_expression(&mut self, name: &str) -> SdbqlResult<Expression> {
    ...
    pub(crate) fn parse_object_expression(&mut self) -> SdbqlResult<Expression> {
    ...
    fn parse_object_key(&mut self) -> SdbqlResult<String> {
        if let Token::Identifier(name) = self.current_token() {
            let k = name.clone();
            self.advance();
            return Ok(k);
    ...
    pub(crate) fn parse_array_expression(&mut self) -> SdbqlResult<Expression> {
