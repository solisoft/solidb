//! Abstract Syntax Tree definitions for SDBQL queries.
//!
//! This module contains all AST node types for representing parsed SDBQL queries.
//! The AST is already serializable with serde for storage and transmission.
