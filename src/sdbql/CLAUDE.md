...
### Collection
`FULLTEXT`, `SAMPLE`, `DOCUMENT`, `COLLECTION_COUNT`

### Crypto
`MD5`, `SHA256`, `BASE64_ENCODE`, `BASE64_DECODE`, `ARGON2_HASH`, `ARGON2_VERIFY`

### Other
`IF`, `COALESCE`, `JSON_PARSE`, `JSON_STRINGIFY`, `RANGE`, `ASSERT`, `SLEEP`
