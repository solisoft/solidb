...
use crate::sdbql::ast::BinaryOperator;
...
impl Parser {
    ...
    pub(super) fn parse_comparison_operator(&mut self) -> DbResult<Option<BinaryOperator>> {
    ...
    fn parse_negated_operator(&mut self) -> DbResult<Option<BinaryOperator>> {
