...
pub const PURE_FUNCTIONS: &[&str] = &[
    ...
    "PARSE_COLLECTION", "PARSE_KEY", "UNSET_RECURSIVE", "KEEP_RECURSIVE", "GET", "SET_PATH", "UNSET_PATH", "DEEP_MERGE",
    ...
    "DATE_TIMESTAMP", "DATE_FORMAT", "DATE_PARSE", "DATE_TRUNC", "DATE_ROUND", "DATE_DAYS_IN_MONTH",
